  ...
  return [
    data.part_list.map((i, index) => {
      ...
      let sortedDimensions = itemize.sort(function (a, b) {
        return numQty(a.height) - numQty(b.height);
      });
      let sortedQty = sortedDimensions.sort(function (a, b) {
        ...
        return v.forEach((item, index) => {
          let mb = {
            columns: [
              ...
              {
                text: `= ${LinearIN(v, i, breakdowns)} Lin IN`,
                style: 'fonts',
              },
              { text: '', style: 'fonts' },
            ],
      ...
      return [
        {
          stack: [
            ...
            {
              text: 'Box Sides / Box Fronts & Backs - Linear Inch Material Breakdown - "Width x Thickness"',
              style: 'fonts',
              margin: [0, 12, 0, 0],
            },
            {
