      ...
      return [
        {
          ...
          columns: [
            ...
            },
            {
              stack: [
                {
                  text: `Profile: ${i.profile ? i.profile.NAME : i.miter_design ? i.miter_design.NAME : i.mt_design ? i.mt_design.NAME : 'None'}`,
                  style: 'fonts'
                },
                {
                  image: i.profile ? m : i.miter_design ? md : i.mt_design ? mtd : blob,
                  width: 100,
                  height: 100,
                  fit: [100, 100]
                }
