      ...
      >
        <Card style={{ height: '100%' }} onClick={() => setCard(card)}>
          ...
          <CardBody>
            ...
            <CardTitle>
              <strong>Side Deduction:</strong> {card.SIDE_DEDUCTION}
            </CardTitle>
            <CardTitle>
              <strong>Bottom Width Reduction:</strong>{' '}
              {card.BOTTOM_WIDTH_REDUCTION}
            </CardTitle>
            <CardTitle>
              <strong>Bottom Length Deduction:</strong>{' '}
              {card.BOTTOM_LENGTH_DEDUCTION}
            </CardTitle>
          </CardBody>
        </Card>
      </div>
            ...
            <ModalBody>
              ...
              <Row>
                ...
                <Col>
                  ...
                  <Input
                    type="number"
                    value={product.BOTTOM_WIDTH_REDUCTION}
                    name="BOTTOM_WIDTH_REDUCTION"
                    onChange={(e) => change(e)}
                  ></Input>
                </Col>
              </Row>
              <Row>
                <Col>
                  ...
                  <Input
                    type="number"
                    value={product.BOTTOM_LENGTH_DEDUCTION}
                    name="BOTTOM_LENGTH_DEDUCTION"
                    onChange={(e) => change(e)}
                  ></Input>
                </Col>
              </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(BoxThickness);
