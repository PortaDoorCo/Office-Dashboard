      ...
      >
        <Card style={{ height: '100%' }} onClick={() => setCard(card)}>
          ...
          <CardBody>
            ...
            <CardTitle>
              <strong>4/4 Openings Price:</strong> ${card.opening_cost}
            </CardTitle>
            <CardTitle>
              <strong>5/4 Openings Price:</strong> ${card.opening_5_4_cost}
            </CardTitle>
          </CardBody>
        </Card>
      </div>
            ...
            <ModalBody>
              ...
              <Row>
                ...
                <Col>
                  ...
                  <Input
                    type="number"
                    value={product.opening_5_4_cost}
                    name="opening_5_4_cost"
                    onChange={(e) => change(e)}
                  ></Input>
                </Col>
              </Row>
