      ...
      >
        <Card style={{ height: '100%' }} onClick={() => setCard(card)}>
          ...
          <CardBody>
            ...
            <CardTitle>
              <strong>Panel Factor: </strong> {card.PANEL_FACTOR}
            </CardTitle>
            <CardTitle>
              <strong>Thickness: </strong> {card.Thickness}
            </CardTitle>
            <CardTitle>
              <strong>Flat: </strong> {card.Flat ? 'Yes' : 'No'}
            </CardTitle>
            <CardTitle>
