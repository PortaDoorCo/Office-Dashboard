...
const Designs = (props) => {
  ...
  const updateProduct = async () => {
    ...
    await props.updateProduct(id, updatedProduct, 'cope-df-designs', cookie);
  ...
  const deleteProduct = async () => {
    ...
    await props.deleteProduct(id, 'cope-df-designs', cookie);
  ...
  const submitProduct = async () => {
    ...
    await props.addProduct(submittedProduct, 'cope-df-designs', cookie);
    await setModal(!modal);
  };
            ...
            <ModalBody>
              ...
              <Row>
                ...
                <Col>
                  ...
                  <Input type="number" value={product.BTM_RAIL_ADD} name="BTM_RAIL_ADD" onChange={(e) => change(e)}></Input>
                </Col>
              </Row>
