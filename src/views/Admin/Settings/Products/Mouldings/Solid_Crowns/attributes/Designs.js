...
const Designs = (props) => {
  ...
  useEffect(() => {
    const filteredProduct = props.designs.filter((x) => x.Style === 'Solid_Crown');
  ...
  const updateProduct = async () => {
    ...
    await props.updateProduct(id, updatedProduct, 'mouldings', cookie);
  ...
  const deleteProduct = async () => {
    ...
    await props.deleteProduct(id, 'mouldings', cookie);
  ...
  const submitProduct = async () => {
    ...
    await props.addProduct(submittedProduct, 'mouldings', cookie);
    await setModal(!modal);
  };
      ...
      >
        <Card style={{ height: '100%' }} onClick={() => setCard(card)}>
          ...
          <CardBody>
            ...
            <CardTitle>
              <strong>Moulding Width:</strong> {card.MOULDING_WIDTH}
            </CardTitle>
            <CardTitle>
              <strong>Moulding Thickness:</strong> {card.MOULDING_THICKNESS}
            </CardTitle>
            <CardTitle>
              <strong>Multiplier:</strong> {card.Multiplier}
            </CardTitle>
          </CardBody>
        </Card>
      </div>
...
const mapStateToProps = (state) => ({
  designs: state.part_list.mouldings,
