        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    <Column dataField="LIP_FACTOR" caption="Lip Factor" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="RAIL_ADD" caption="Rail Add" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="STILE_ADD" caption="Stile Add" fixed={true} ><RequiredRule /></Column>
