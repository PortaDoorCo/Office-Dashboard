        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    <Column dataField="MINIMUM_STILE_WIDTH" caption="Stile Width" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="MID_RAIL_MINIMUMS" caption="Mid Rail Widths" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="INSET" caption="Inset" fixed={true} ><RequiredRule /></Column>
