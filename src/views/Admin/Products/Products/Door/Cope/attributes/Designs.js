        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    <Column dataField="UPCHARGE" caption="4/4 Price" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="UPCHARGE_THICK" caption="5/4 Price" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="TOP_RAIL_ADD" caption="Top Arch" fixed={true} ><RequiredRule /></Column>
                    <Column dataField="BTM_RAIL_ADD" caption="Bottom Arch" fixed={true} ><RequiredRule /></Column>
