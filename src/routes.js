...
const routes = [
  ...
  { path: '/door-order', name: 'Door Order', component: OrderContainer, type: 'Door Order' },
  { path: '/drawer-order', name: 'Drawer Order', component: OrderContainer, type: 'Drawer Order' },
  ...
  { path: '/mouldings', name: 'Mouldings', component: OrderContainer, type: 'Mouldings' },
  { path: '/face-frames', name: 'FaceFrames', component: OrderContainer, type: 'Face Frame' },
];
