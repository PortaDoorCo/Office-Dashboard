...
const Maker = (props) => {
  ...
  let verticalMidRailSize = formState.part_list[i].dimensions[index]
    ...
    : 0;
  let unevenInput1 = formState.part_list[i].dimensions[index].unevenSplitInput0
    ? numQty(formState.part_list[i].dimensions[index].unevenSplitInput0)
    : 0;
  let unevenInput2 = formState.part_list[i].dimensions[index].unevenSplitInput1
    ? numQty(formState.part_list[i].dimensions[index].unevenSplitInput1)
    : 0;
  let unevenInput3 = formState.part_list[i].dimensions[index].unevenSplitInput2
    ? numQty(formState.part_list[i].dimensions[index].unevenSplitInput2)
    : 0;
  let unevenInput4 = formState.part_list[i].dimensions[index].unevenSplitInput3
    ? numQty(formState.part_list[i].dimensions[index].unevenSplitInput3)
    : 0;
  let unevenInput5 = formState.part_list[i].dimensions[index].unevenSplitInput4
